  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        desktopHero: "url('/desktop/image-hero.webp');",
        aboutImage: "linear-gradient(rgba(187, 5, 69, 0.9), rgba(187, 5, 69, 0.95)), url('/desktop/image-hero.webp');",
        courseImage: "linear-gradient(rgba(187, 5, 69, 0.95), rgba(187, 5, 69, 0.95)), url('/bachata-dancing.webp');",
        instructorsImage: "linear-gradient(rgba(187, 5, 69, 0.95), rgba(187, 5, 69, 0.99)), url('/logo.webp');",
      },
      colors: {
        gold: '#D5966C',
        almostBlack: '#151515',
