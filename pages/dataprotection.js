...
const DataPrivacy = () => {
  ...
  return (
    <Layout title="Latin Shine - Data Protection page" description="Latin Shine Dance Company respects your data, learn more about data protection policies on this page">
