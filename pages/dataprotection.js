...
const DataPrivacy = () => {
  ...
  return (
    <Layout title="Latin Shine | Dance Company - Data Protection" description="Latin Shine Dance Company respects your data, learn more about data protection policies on this page">
