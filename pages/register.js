...
const Register = (props) => {
  ...
  return (
    <Layout title="Latin Shine | Dance Company - Register" description="You can register on our website to manage payments and reserve spots for our Bachata Sensual latin dance classes.">
